...
b=l2.countlabel("select count(*) as abc from tbluser where pid="+a,"abc");
String price=l2.filllabel("select * from tblpackage where pid="+a, "price");
c=Integer.parseInt(price);
int d=b*c;


String ptype=l2.filllabel("select * from tblpackage where pid="+a, "ptype");
map = new HashMap<Object,Object>(); map.put("label", ptype+""); map.put("y", d); map.put("exploded", true); list.add(map);
